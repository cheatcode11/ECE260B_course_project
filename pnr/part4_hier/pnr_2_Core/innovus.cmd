...
#  Created on Fri Mar  7 01:09:15 2025                
#                                                     
#######################################################
...
set init_lef_file {/home/linux/ieng6/ee260bwi25/public/PDKdata/lef/tcbn65gplus_8lmT2.lef ./subckt/sram_w16.lef}
create_library_set -name WC_LIB -timing "$worst_timing_lib ./subckt/sram_w16_WC.lib"
create_library_set -name BC_LIB -timing "$best_timing_lib ./subckt/sram_w16.lib"
set init_pwr_net VDD
set init_gnd_net VSS
set init_verilog ./netlist/fullchip.out.v
set init_design_netlisttype Verilog
...
addStripe -number_of_sets 5 -spacing 0.4 -layer M5 -width 1 -nets { VSS VDD } -direction horizontal -start 33 -stop 84
setObjFPlanBox Instance qmem_instance 25 75.5 53 99.9
setObjFPlanBox Instance kmem_instance 25 25.8 53 52.2
setObjFPlanBox Instance psum_mem_instance 25 125 53 52.2
