# Load design
set desdir 		"/home/linux/ieng6/ee260bwi25/nbaimeedi/Project/Local_Project/Core_PnR_Run_0"
...
set init_lef_file "$lef ./Sub_Module/sram_w16.lef ./Sub_Module/sram_w16_2.lef"

# MCMM setup
create_library_set -name WC_LIB -timing "$worst_timing_lib ./Sub_Module/sram_w16_WC.lib ./Sub_Module/sram_w16_2_WC.lib"
create_library_set -name BC_LIB -timing "$best_timing_lib ./Sub_Module/sram_w16_BC.lib ./Sub_Module/sram_w16_2_BC.lib"
