streamOut ${design}.gds2 -merge {./Sub_Module/sram_w16.gds2 ./Sub_Module/sram_w16_2.gds2}
write_lef_abstract ${design}.lef
#write_lef_abstract -stripePin -PGPinLayer {4} -extractBlockPGPinLayers {4} ${design}.lef -specifyTopLayer 4
